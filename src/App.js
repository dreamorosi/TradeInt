...
class App extends Component {
  ...
  handleScroll (isVisible) {
    if (isVisible && !this.pageView) {
      window.ga('send', 'event', { eventCategory: 'Scrolled to Why section', eventAction: 'Scroll' })
      this.pageView = true
    }
  }
    ...
    return (
      <Wrapper>
        ...
        <Row padding='70px 0 0 0'>
          <Col id='signup'>
            <Form thanks={form.thanks} textInput={form.textInput} emailInput={form.emailInput} button={form.button} />
          </Col>
        </Row>
